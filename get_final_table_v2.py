...
def evaluate_fold(fold):
    ...
    ckpt_path = f"./checkpoints_msa/fold_{fold}/best_model.pth"
    ...
    # 加载模型
    model = MSA_Baseline_SAM2(checkpoint_path="./checkpoints/sam2_hiera_large.pt").to(DEVICE)
...
if __name__ == "__main__":
    ...
    try:
        # 初始化一个临时模型用于计算参数
        temp_model = MSA_Baseline_SAM2(checkpoint_path="./checkpoints/sam2_hiera_large.pt").to(DEVICE)
